...
class Tool:
    ...
    def __init__(self, name, base_price):
        ...
        self.__current_price = base_price

    def put_on_sale(self):
        """
        make this item be on sale.
        """
        self.__current_price = self.discounted_price()
    ...
    def take_off_sale(self):
        ...
        """
        self.__current_price = self.__base_price
    ...
    def change_discount(self, new_rate):
        ...
        :param new_rate: new discount rate. cannot be higher than the maximum allowed discount of 70%.
                ++ ADD MINIMUM DISCOUNT RATE?
        """
        if new_rate < MAXIMUM_DISCOUNT_RATE:
    ...
    def is_on_sale(self):
        ...
        """
        if self.__current_price == self.__base_price:
            return False
        else:
            return True
