...
/**
 *
 * Below is other brief testing I did for small helper functions, similar to what you would
 * find if we had an if name == main.
 *
 Card sampleCard;
 sampleCard = new Card(13,"Hearts");
 System.out.println(sampleCard.getRank());
 System.out.println(sampleCard);

 Card another = new Card(4,0);
 ...
 PokerHand hand1;
 hand1 = new PokerHand(newDeck.deal(5));

 hand1.addCard(another);
 System.out.println(hand1);
 System.out.println(hand1.isPair());
 //System.out.println(hand1.setOfRanksList());
 //System.out.println(hand1.setOfSuitsList());
 //System.out.println(hand1.sortedRankList());
